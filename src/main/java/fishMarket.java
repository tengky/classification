...
public class fishMarket {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //set filepath
        File datafile = new ClassPathResource("/fish_market/Fish.csv").getFile();
        ...
        DataSetIterator dataSetIterator = new RecordReaderDataSetIterator(collectionRR, processData.size(), 0, 7);
